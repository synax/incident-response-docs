# Synax Incident Response Documentation
This is a public version of the Incident Response process used at Synax. It is also used to prepare new employees for on-call responsibilities, and provides information not only on preparing for an incident, but also what to do during and after. See the [about page](docs/about.md) for more information on what this documentation is and why it exists.

You can view the documentation [directly](docs/index.md) in this repository, or rendered as a website at https://response.synax.io.
...
1. Install the [Synax MkDocs Theme](https://github.com/synax/mkdocs-theme-synax).
    1. `git clone https://github.com/synax/mkdocs-theme-synax`
    1. `cd mkdocs-theme-synax & python3 setup.py install`
...
1. Fork it ( https://github.com/Synax/incident-response-docs/fork )
